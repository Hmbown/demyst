...
class TestTorchVariation:
    ...
    def test_collapse_records_history(self):
        ...
        from scilint.integrations.torch_hooks import TorchVariation
...
class TestJaxVariation:
    ...
    def test_variation_history_structure(self):
        ...
        from scilint.integrations.jax_hooks import JaxVariation
...
class TestExperimentTrackers:
    ...
    def test_cherry_picking_detection(self):
        ...
        report = tracker.get_integrity_report(
            metric_name="accuracy",
            reported_value=0.799  # The best one
        )
...
'''
    ...
    def test_report_generation(self):
        ...
        from scilint.integrations.ci_enforcer import ScientificIntegrityReport, IntegrityCheck
...
class TestPaperGenerator:
    ...
    def test_methodology_extraction(self):
        ...
        from scilint.generators.paper_generator import MethodologyExtractor
        import ast
