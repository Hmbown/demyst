"""
Comprehensive Test Suite for Scilint Guards
...
'''
    ...
    def test_normalization_blindness(self):
        ...
        from scilint.guards.tensor_guard import NormalizationAnalyzer
...
'''
    ...
    def test_reward_hacking_detection(self):
        ...
        from scilint.guards.tensor_guard import RewardHackingDetector
...
'''
        ...
        assert any('multiple' in v['type'].lower() or 'loop' in v['description'].lower()
                  for v in result['violations'])

    def test_bonferroni_correction(self):
        """Test Bonferroni correction calculation."""
        from scilint.guards.hypothesis_guard import BonferroniCorrector
...
'''
    ...
    def test_dimension_inference(self):
        ...
        from scilint.guards.unit_guard import UnitInferenceEngine, Dimension
    ...
    def test_dimension_arithmetic(self):
        ...
        from scilint.guards.unit_guard import Dimension
