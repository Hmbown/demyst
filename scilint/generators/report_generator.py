...
class IntegrityReportGenerator:
    ...
    def to_markdown(self) -> str:
        ...
        lines.extend([
            "---",
            "",
            "*Generated by Scilint Scientific Integrity Platform*",
        ])
...
<body>
    ...
    <footer>
        <p>Generated by <strong>Scilint</strong> - The Scientific Integrity Platform</p>
    </footer>
</body>
</html>"""
    ...
    def _section_to_html(self, section: ReportSection) -> str:
        ...
        if section.issues:
            ...
            for issue in section.issues[:20]:
                ...
                desc = issue.get('description', str(issue))
                line = issue.get('line', '?')
                issues_html += f'<div class="issue {severity}"><strong>Line {line}:</strong> {desc}</div>'
...
"""
    ...
    def _status_html(self, status: str) -> str:
        ...
        return f'<span style="color: {colors.get(status, "#6c757d")}">{icons.get(status, "?")}</span>'
