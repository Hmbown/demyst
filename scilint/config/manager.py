"""
Configuration Manager for Scilint

Handles loading and merging of configuration from:
1. Default settings
2. Domain profiles
3. User .scilintrc.yaml file
"""
...
class ConfigManager:
    ...
    def __init__(self, config_path: Optional[str] = None):
        self.config_path = config_path or ".scilintrc.yaml"
    ...
    def _load_profile(self, profile_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            module_name = f"scilint.profiles.{profile_name}"
            import importlib
